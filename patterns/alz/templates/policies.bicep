...
var loadPolicyDefinitions = {
  All: [
    ...
    loadTextContent('../../../services/Resources/subscriptions/Deploy-LogQuery-ResourceHealth-UnHealthly-Alert.json')
    ...
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-Availability-Alert.json')
    ...
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-WindowsService-Time-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-WindowsService-DHCP-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-WindowsService-DNS-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-WindowsService-RPC-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-WindowsService-Server-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-WindowsService-TCPNetBios-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-WindowsService-Workstation-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-WindowsService-WDF-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-WindowsService-WRM-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-WindowsService-WEL-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-DiskSpaceWarning-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-DiskSpaceCritical-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-CustomCPU-Alert.json')
    loadTextContent('../../../services/Compute/virtualMachines/Deploy-VM-OSDiskIOPSPercentage.json')
  ]
  AzureCloud: []
  AzureChinaCloud: []
  AzureUSGovernment: []
